...
export function DataTable<TData, TValue>({
    ...
    const showPageSizeSelector = rowCount > 10 || data.length === pageSize
        ...
        <div className="space-y-6 w-full min-w-0 text-foreground">
                                                ...
                                                >
                                                    ...
                                                    {{
                                                        ...
                                                        (header.column.getCanSort() ? (
                                                            <ArrowUpDown className="h-3 w-3 text-muted-foreground opacity-30 group-hover:opacity-100 transition-all" />
                                                        ) : null)}
                                                </div>
                                            )}
                                        </TableHead>
                    ...
                    <TableBody>
                        {table.getRowModel().rows.length ? (
                            table.getRowModel().rows.map((row) => (
                                <TableRow
                                    key={row.id}
                                    className="group border-b border-border hover:bg-primary/5 transition-colors last:border-b-0"
                                >
            ...
            {hasData && (
                <div className="flex flex-col sm:flex-row items-center justify-between gap-4 px-2">
                    ...
                    <div className="flex flex-col sm:flex-row items-center gap-6 text-[11px] font-bold uppercase tracking-widest text-slate-400">
                    ...
                    <div
                        className={cn(
                            ...
                            !showPaginationButtons && 'invisible'
                        )}
                    >
                        <Button
                            variant="outline"
